...
Response:
  {
    "task_id": "...",
    "output": { "judge_id": "judge-gamma", "score": 72, "verdict": "VALID", "justification": "..." },
    "status": "completed"
  }
"""
...
AGENT_ID   = os.getenv("AGENT_ID",   "judge-gamma")
AGENT_NAME = os.getenv("AGENT_NAME", "Judge Gamma")
